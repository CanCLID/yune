...
- `apps/yune-web/e2e/results/m29-performance/browser-startup-before.json`
- `apps/yune-web/e2e/results/m29-performance/browser-startup-after.json`
- `apps/yune-web/e2e/results/m29-performance/typing-attribution-before.json`
- `apps/yune-web/e2e/results/m29-performance/typing-attribution-after.json`
...
Result: `apps/yune-web/e2e/results/m29-performance/native-startup-after.md` matches the committed JSON shape and values. Browser startup and typing remain flat/mixed attribution evidence, not M29 engine-win claims.
