...
export const OUTPUT_STANDARD_OPTIONS: readonly OutputStandardOption[] = [
  {
    id: "opencc_traditional",
    label: "傳統漢字 OpenCC Traditional",
    shortLabel: "傳統漢字",
    glyph: "傳",
  },
  {
    id: "hong_kong_traditional",
    label: "香港字形 Hong Kong Traditional",
    shortLabel: "香港字形",
    glyph: "港",
  },
  {
  ...
  {
    id: "mainland_simplified",
    label: "大陆简化字 Mainland Simplified",
    shortLabel: "大陆简化字",
    glyph: "简",
  },
];
...
export function normalizeOutputStandard(
  value: string,
  defaultValue: OutputStandard,
): OutputStandard {
  ...
  switch (value) {
    case "hk_traditional":
      return "hong_kong_traditional";
    case "traditional":
      return "opencc_traditional";
    case "simplified":
      return "mainland_simplified";
    case "variants_hk":
      return "hong_kong_traditional";
    case "trad_tw":
...
export const definitionLayout = [
  [Language.Eng, Language.Ind],
  [Language.Hin, Language.Nep],
  [Language.Urd],
];

export const otherData: Record<
  string,
  Exclude<keyof CandidateEntry["properties"], "definition">
> = {
