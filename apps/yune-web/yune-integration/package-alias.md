...
The active app root declares the local dependency directly:
...
The active implementation lives in `apps/yune-web/src/yune-integration/`. The
top-level `apps/yune-web/yune-integration/` files are compatibility re-exports
for older repo references.
