...
_Requirements defined: 2026-04-28_ _Last updated: 2026-06-24 - M36 is complete as the product-path engine optimization milestone after M35. It keeps fair `luna_pinyin` comparison separate from TypeDuck `jyut6ping3_mobile` product before/after evidence, adds native in-process measurement, records actual shipped TypeDuck product blobs as stale/unsupported for Yune, closes `rsmarisa` by measured no-go for this milestone, lands schema-scoped no-marisa re-emitted compiled assets with configured product prism stems, enables compact storage only for compiled product loads, regenerates performance/root-cause reports and visualizations, and preserves no-go reporting discipline. Track B product rows improve up to `81.7%`, product max peak working set drops from `1000.4 MB` to `885.3 MB`, and Track A still trails librime widely. Browser/runtime/Cloudflare/OpenCC delivery work remains M31. M35 remains complete as the compact table+prism runtime storage milestone. M33, M34, P2-WIN-02, M30, M29, M28 follow-up, M28, M27, M26, M25, M24, M19, M23, M18, M22, M21, M20, and M10 remain complete as previously recorded._
