...
comparator remains `2/5`, and owner re-disposition is still the stop before 4b.
...
performance gate, threshold, milestone, or change to the Windows disposition.
...
packet, strict Lane A `2/5` result, pending owner re-disposition, or broader
Lane B requirement. [Original diagnostic](./reports/evidence/m59-macos-librime-analysis-20260710/README.md);
