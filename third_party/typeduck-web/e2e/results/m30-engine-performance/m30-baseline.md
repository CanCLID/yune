...
```powershell
$env:TYPEDUCK_APP_URL='http://localhost:5173/web/'; $env:M29_EVIDENCE_LABEL='m30-before'; npm.cmd --prefix third_party\typeduck-web\e2e run test:e2e -- --grep "M29 PERF" --workers=1
```
